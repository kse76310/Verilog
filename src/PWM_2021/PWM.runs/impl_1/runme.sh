...
HD_PWD='D:/project1/FPGA/src/PWM_2021/PWM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_dcmotor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm_dcmotor.tcl -notrace
