...
HD_PWD='D:/project1/FPGA/src/PWM_2021/PWM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_dcmotor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_dcmotor.tcl
