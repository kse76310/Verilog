...
HD_PWD='D:/project1/FPGA/src/13.microwave/13.microwave.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_micro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_micro.tcl
