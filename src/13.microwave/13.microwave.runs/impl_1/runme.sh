...
HD_PWD='D:/project1/FPGA/src/13.microwave/13.microwave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_micro.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_micro.tcl -notrace
