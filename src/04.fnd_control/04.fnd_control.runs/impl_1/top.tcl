...
namespace eval ::optrace {
  variable script "D:/project1/FPGA/src/04.fnd_control/04.fnd_control.runs/impl_1/top.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet D:/project1/FPGA/src/04.fnd_control/04.fnd_control.runs/synth_1/top.dcp
