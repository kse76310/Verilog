...
HD_PWD='D:/project1/FPGA/src/11_my_piezo_buzzer/11_my_piezo_buzzer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_buzzer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_buzzer.tcl
