...
HD_PWD='D:/project1/FPGA/src/11_my_piezo_buzzer/11_my_piezo_buzzer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_buzzer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_buzzer.tcl -notrace
