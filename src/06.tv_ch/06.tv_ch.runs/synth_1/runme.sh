...
HD_PWD='D:/project1/FPGA/src/06.tv_ch/06.tv_ch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tv_ch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tv_ch.tcl
